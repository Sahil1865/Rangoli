...
const featuredImgList1= [imgicstationery,imgicgifts,imgicaccessories];
const featuredImgList2= [imgicsports,imgictoys,imgicgames];

const featuredTitlesList1= [stationery,gifts,accessories];
